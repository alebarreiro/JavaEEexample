...
public class NewMessageBean implements MessageListener {
    ...
    //Insert Entity Manager, also generates the persist(save) method
    @PersistenceContext(unitName = "JavaEEexample-ejbPU")
    ...
    public void onMessage(Message message) {
        // Cuando hay un nuevo mensaje, este codigo se ejecuta (async)
